...
class _ProgramRegisterScreenState extends State<ProgramRegisterScreen> {
  final ProgramRegisterController _programRegisterController = Get.put(ProgramRegisterController());
              ...
              Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Padding(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    validator: (value) => value == null ?  "Select Participant Type": null,
                  ...
                  onTap: () {
                    if(userModel.isNotEmpty){
                      for(int i=0; i<userModel.length; i++){
                        if(phoneController.text == userModel[i].phone){
                          setState(() { numberUsed = true; });
                        }else{
                          setState(() { numberUsed = false; });
                        }
                      }
                    }
                    if(numberUsed == false){
                            ...
                            if(phoneController.text.isNotEmpty){
                              if(selectedType != null){
                                if(selectedProject != null) {
                                  _programRegisterController.addProgramRegisterData(
                                ...
                                errorToast("Error", "Select the Type First");
                              }
                            }else{
                      ...
                      errorToast("Error", "This phone number already used");
                    }
                  ...
                  child: Container(
                    child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            color: vibrantOrange),
                        child: Obx(() {
                          return _programRegisterController.isLoading.isTrue
