                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: InkWell(
                          ...
                          child: Image.network("https://childrensliteraturefestival.com/wp-content/uploads/2021/03/Peace-ing_Together.gif")),
                    ),
                    SizedBox(
                      height: 30,
                    ),
                            ...
                            Navigator.push(
                                ...
                                PageRouteBuilder(
                                    ...
                                    pageBuilder: (context, _, __) {
                                      return WebViewPage(
                                          title: "Kitab Gari",
                                          url: UrlBase.baseWebURL + UrlPathHelper.getValue(UrlPath.kitabGarri));
                                    },
                                    transitionsBuilder: (_, __, ___, Widget child) {
                                      return child;
                                    }));
                          },
                          child: Image.network("https://childrensliteraturefestival.com/wp-content/uploads/2020/08/CLF_Kitab_Gari-1.jpg")),
                    ),
